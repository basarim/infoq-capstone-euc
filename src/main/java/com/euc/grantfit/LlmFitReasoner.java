...
public class LlmFitReasoner implements FitReasoner {
    ...
    private String buildPrompt(Organization org, GrantOpportunity grant, EucDefinition euc) {
        ...
        sb.append("Assess mission and program alignment. Cite specific evidence from the ")
                .append("organization's profile for your conclusion. If evidence is insufficient, ")
                .append("say so explicitly rather than guessing.\n\n");
